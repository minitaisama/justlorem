...
export default function Banner() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen overflow-hidden bg-[#030712]">
      <div className="absolute inset-0">
        {STARS.map((star, i) => (
          <motion.div
            ...
            animate={{ opacity: [star.opacity * 0.75, star.opacity] }}
            transition={{
              duration: 3,
              repeat: Infinity,
              repeatType: "reverse",
      ...
      <motion.div
        style={{ y, opacity }}
        className="relative z-10 mx-auto flex min-h-[78vh] w-full max-w-[1400px] flex-col gap-10 px-6 pb-32"
      >
        <div className="relative top-6 my-6">
          <div className="mt-16 text-center">
            <motion.p
              ...
              className="mb-4 text-[18px] leading-[22px] tracking-[0.3em] text-muted-foreground uppercase"
            >
            ...
            <motion.h1
              ...
              className="mb-8 min-h-[1.1em] text-7xl font-display tracking-tight md:text-9xl lg:text-[10rem]"
            >
              <motion.span
          ...
          >
            <div className="relative h-[150px] w-[300px]">
              ...
              <div className="absolute top-1/2 left-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#2F5FB3] blur-sm" />
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="mt-6 flex gap-4">
              <Link
                ...
                className="rounded-full border border-white/20 px-6 py-3 text-sm text-white transition-colors duration-300 hover:border-[#2F5FB3] hover:text-[#2F5FB3]"
              >
                See Our Works
              </Link>
              <Link
                href="https://calendar.app.google/AC9XWNQLaUhp3yMq9"
                className="rounded-full bg-white px-6 py-3 text-sm text-black transition-all duration-300 hover:bg-[#2F5FB3] hover:text-white"
                target="_blank"
                rel="noreferrer"
              >
                Book Free Call
